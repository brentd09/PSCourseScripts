...
# Added resize to Value column to make it a little prettier
...
### Added Function to deal with "non Strings" - I haven't used "Default" for strings as there's still types which haven't been identified here.
